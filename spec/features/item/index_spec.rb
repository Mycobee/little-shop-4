...
RSpec.describe "As a visitor" do
  ...
  describe 'When I visit items index page' do
    xit "There is an area for statistics, 5 most popular and 5 least popular" do
      merchant = create(:merchant)

      item_1 = create(:item, user: merchant, quantity: 100)
      item_2 = create(:item, user: merchant, quantity: 100)
      item_3 = create(:item, user: merchant, quantity: 100)
      item_4 = create(:item, user: merchant, quantity: 100)
      item_5 = create(:item, user: merchant, quantity: 100)
      item_6 = create(:item, user: merchant, quantity: 100)
      item_7 = create(:item, user: merchant, quantity: 100)
      item_8 = create(:item, user: merchant, quantity: 100)
      item_9 = create(:item, user: merchant, quantity: 100)
      item_10 = create(:item, user: merchant, quantity: 100)
      item_11 = create(:item, user: merchant, quantity: 100)
      item_12 = create(:item, user: merchant, quantity: 100)
      item_13 = create(:item, user: merchant, quantity: 100)
      item_14 = create(:item, user: merchant, quantity: 100)
      item_15 = create(:item, user: merchant, quantity: 100)

      user = create(:user)
      order_1 = create(:order, user: user)

      fulfilled_order_item_1 = create(:fulfilled_order_item, order: order_1, item: item_1, quantity: 15)
      fulfilled_order_item_2 = create(:fulfilled_order_item, order: order_1, item: item_2, quantity: 14)
      fulfilled_order_item_3 = create(:fulfilled_order_item, order: order_1, item: item_3, quantity: 13)
      fulfilled_order_item_4 = create(:fulfilled_order_item, order: order_1, item: item_4, quantity: 12)
      fulfilled_order_item_5 = create(:fulfilled_order_item, order: order_1, item: item_5, quantity: 11)
      fulfilled_order_item_6 = create(:fulfilled_order_item, order: order_1, item: item_6, quantity: 10)
      fulfilled_order_item_7 = create(:fulfilled_order_item, order: order_1, item: item_7, quantity: 9)
      fulfilled_order_item_8 = create(:fulfilled_order_item, order: order_1, item: item_8, quantity: 8)
      fulfilled_order_item_9 = create(:fulfilled_order_item, order: order_1, item: item_9, quantity: 7)
      fulfilled_order_item_10 = create(:fulfilled_order_item, order: order_1, item: item_10, quantity: 6)
      fulfilled_order_item_11 = create(:fulfilled_order_item, order: order_1, item: item_11, quantity: 5)
      fulfilled_order_item_12 = create(:fulfilled_order_item, order: order_1, item: item_12, quantity: 4)
      fulfilled_order_item_13 = create(:fulfilled_order_item, order: order_1, item: item_13, quantity: 3)
      fulfilled_order_item_14 = create(:fulfilled_order_item, order: order_1, item: item_14, quantity: 2)
      fulfilled_order_item_15 = create(:fulfilled_order_item, order: order_1, item: item_15, quantity: 1)

      visit items_path

      within("top-five") do
      expect(page).to have_content(item_1.name)
      expect(page).to have_content(fulfilled_order_item_15.quantity)
